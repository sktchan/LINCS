#=
THIS FILE CALCULATES ACCURACY INSTEAD OF ERROR
=#
...
open(params_txt, "w") do io
    ...
    println(io, "ADDITIONAL NOTES: running with scatter plot and same params as exp transf")
