...
# X_masked_full, y_masked_full = mask_input(X, mask_ratio=0.001)
...
println("smaug finished: alloc checking done!")
...
open(params_txt, "w") do io
    ...
    println(io, "ADDITIONAL NOTES: checking allocs of train loop pt2")
end
...
println("smaug finished: logging done!")
